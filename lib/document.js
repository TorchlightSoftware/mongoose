 ...
 * @param {Function} entryStack optional the function in user code that called us
 * @api public
 */

Document.prototype.invalidate = function (path, err, val, entryStack) {
  if (!this.$__.validationError) {
    this.$__.validationError = new ValidationError(this, entryStack);
  }
